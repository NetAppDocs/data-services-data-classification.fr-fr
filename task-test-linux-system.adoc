...
Le script d'installation de NetApp Data Classification inclut un script de test permettant de vérifier que votre environnement répond aux exigences. Vous pouvez exécuter ce script séparément pour vérifier la préparation de l'hôte Linux avant d'exécuter le script d'installation.
...
Tu peux link:https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-on-prem.html["installer l'agent de console sur site"^] sur un serveur Linux de votre réseau ou sur un serveur Linux dans le cloud. Vous pouvez également installer la classification des données sur site si l'agent de la console est installé sur site.

Pour créer un agent Console dans votre environnement de fournisseur de cloud, consultez :

* https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["création d'un agent de console dans AWS"^]
* https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-azure.html["création d'un agent de console dans Azure"^]
* https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-google.html["création d'un agent de console dans GCP"^]
...
. Le script vous demande si vous disposez d'un agent de console installé.
+
