...
---
= Consultez les détails de conformité relatifs aux données privées de l'organisation avec NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Les informations de conformité au niveau des fichiers ne sont disponibles que si vous effectuez une analyse de classification complète. Les analyses basées uniquement sur les cartes ne fournissent pas de détails au niveau des fichiers.
...
+
image:screenshot_compliance_investigation_page.png["Capture d'écran des informations détaillées trouvées dans les fichiers après avoir sélectionné « Investigate Results »."]

+
image:screenshot_compliance_investigation_page_directory.png["Capture d'écran des informations détaillées trouvées dans les répertoires après avoir sélectionné Investigate Results."]
...
. Explorez les données en effectuant une recherche, un tri, en développant les détails d'un fichier spécifique, en sélectionnant *Investigate Results* pour afficher les informations masquées, ou en téléchargeant la liste des fichiers.
