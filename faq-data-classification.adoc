...
L'analyse cartographique seule ne réchauffe pas les données froides : elles restent froides et demeurent dans le stockage d'objets. En revanche, si vous effectuez une analyse complète, certaines configurations peuvent réchauffer les données froides.
