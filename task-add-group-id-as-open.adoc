...
summary: 'Lorsque des identifiants de groupe sont associés à des fichiers ou des dossiers sur des partages de fichiers NFS, ils définissent les autorisations pour le fichier ou le dossier. Si les identifiants de groupe ne sont pas configurés avec le niveau d"autorisation « Open to Organization », vous pouvez ajouter cette autorisation à l"identifiant de groupe afin que tous les fichiers et dossiers auxquels cet identifiant est associé soient considérés comme « open to the organization ».' 
---
