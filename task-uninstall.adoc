...
. Sélectionnez **Désinstaller la classification des données**.
...
. Dans la boîte de dialogue, saisissez « uninstall » pour déconnecter l’instance de Data Classification de l’agent Console. Sélectionnez **Uninstall** pour confirmer.
