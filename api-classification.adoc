...
Pour accéder à Swagger, vous aurez besoin de l'adresse IP de votre instance Data Classification. Dans le cas d'un déploiement cloud, vous utiliserez l'adresse IP publique. Ensuite, vous devrez accéder à ce endpoint :
