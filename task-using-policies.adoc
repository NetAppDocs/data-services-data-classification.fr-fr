...
Pour afficher les résultats des requêtes enregistrées sur la page Investigation, sélectionnez le bouton image:button-gallery-options.gif["Bouton Plus"] pour une recherche, puis sélectionnez *Analyser les résultats*.
