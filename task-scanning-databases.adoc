...
TIP: Il n'existe aucune option permettant de sélectionner uniquement les analyses de cartes pour les schémas de base de données.

. Sur la page Configuration, sélectionnez le bouton *Manage* correspondant à la base de données que vous souhaitez configurer.
+
...
. Pour chaque schéma pour lequel vous souhaitez activer les analyses, sélectionnez la colonne *Type d'analyse* puis définissez l'analyse sur désactivée ou **Analyse complète**.
